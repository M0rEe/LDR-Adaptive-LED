...
#define LCD_4_BIT_D7_PIN        DIO_PIN4

#define LCD_4_BIT_RS_PORT       DIO_PORTA
#define LCD_4_BIT_RS_PIN        DIO_PIN3

#define LCD_4_BIT_RW_PORT       DIO_PORTA
#define LCD_4_BIT_RW_PIN        DIO_PIN2

#define LCD_4_BIT_EN_PORT       DIO_PORTA
#define LCD_4_BIT_EN_PIN        DIO_PIN2
